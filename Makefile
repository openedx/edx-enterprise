...
clean.static: ## remove all ignored generated static files
	rm -rf src/enterprise/assets/
	rm -rf src/enterprise/static/enterprise/bundles/*.js
...
dummy_translations: ## generate dummy translation (.po) files
	cd src/enterprise && i18n_tool dummy
...
pull_translations: ## Pull translations from openedx-translations via Atlas
	rm -rf src/enterprise/conf/locale src/consent/conf/locale
	mkdir -p src/enterprise/conf/locale src/consent/conf/locale
	atlas pull $(ATLAS_OPTIONS) \
		translations/edx-enterprise/enterprise/conf/locale:src/enterprise/conf/locale \
		translations/edx-enterprise/consent/conf/locale:src/consent/conf/locale \
		$(ATLAS_EXTRA_SOURCES)
...
jshint: ## run Javascript linting
	...
	./node_modules/jshint/bin/jshint src/enterprise
