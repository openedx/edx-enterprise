...
class CanvasEnterpriseCustomerConfigurationSerializer(EnterpriseCustomerPluginConfigSerializer):
    ...
    class Meta:
        ...
        fields = ('client_id', 'client_secret', 'canvas_account_id', 'canvas_base_url',
                  'refresh_token', 'transmission_chunk_size', 'uuid', 'channel_code',
                  'oauth_authorization_url', 'is_valid', 'last_sync_attempted_at', 
                  'last_content_sync_attempted_at', 'last_learner_sync_attempted_at',
                  'last_sync_errored_at', 'last_content_sync_errored_at', 
