    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(help_text='OAuth client identifier.', max_length=255, verbose_name='Client ID')),
                ('sapsf_base_url', models.CharField(help_text='Base URL of success factors API.', max_length=255, verbose_name='SAP Base URL')),
                ('sapsf_company_id', models.CharField(help_text='Success factors company identifier.', max_length=255, verbose_name='SAP Company ID')),
                ('sapsf_user_id', models.CharField(help_text='Success factors user identifier.', max_length=255, verbose_name='SAP User ID')),
                ('secret', models.CharField(help_text='OAuth client secret.', max_length=255, verbose_name='Client Secret')),
