...
class ContentMetadataExporter(Exporter):
    ...
    def export(self):
        """
        Return the exported content metadata in JSON format and the HTTP method to use for transmission.
        """
        ...
        for item in content_metadata_items:
            ...
            content_metadata_export[content_metadata_item_export.aggregation_key] = content_metadata_export
        return content_metadata_export
        ...
        for integrated_channel_schema_key, edx_data_schema_key in self.DATA_TRANSFORM_MAPPING.items():
            ...
            if transformer:
                ...
                try:
                    ...
                    LOGGER.exception(
                        'Failed to transform content metadata item field for [%s]: [%s]',
...
class ContentMetadataItemExport(object):
    ...
    def __init__(self, content_metadata_item, channel_content_metadata_item):
        self.aggregation_key = content_metadata_item['aggregation_key']
