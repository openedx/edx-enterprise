...
version = get_version('edx-enterprise')
...
#
html_theme_options = {
 "repository_url": "https://github.com/openedx/edx-enterprise",
...
def on_init(app):
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'src', 'enterprise'),
                os.path.join(root_path, 'src', 'enterprise', 'migrations')])
