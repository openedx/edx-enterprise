# -*- coding: utf-8 -*-
# Generated by Django 1.11.29 on 2020-04-10 19:55
...
# Notes for manual function udpates:
# 0051_add_enterprise_slug.populate_slug
# - Removed data migration only needed for existing data
# 0067_add_role_based_access_control_switch, 0068_remove_role_based_access_control_switch
# - noop with these two migrations taken together
# 0073_enterprisecustomerreportingconfiguration_uuid.create_uuid
# - In place of AddField, create defaults, AlterField; squashed to just AddField.
# 0081_UpdateEnterpriseEnrollmentSource.update_source
# - Updated directly in ENTERPRISE_ENROLLMENT_SOURCES
# 0082_AddManagementEnterpriseEnrollmentSource.update_source
# - Added directly to ENTERPRISE_ENROLLMENT_SOURCES
