...
class EnterpriseCustomer(TimeStampedModel):
    ...
    enable_data_sharing_consent = models.BooleanField(
        ...
        help_text=_(
            ...
            "disabled for learners signing in through this enterprise customer. If disabled, consent "
...
class UserDataSharingConsentAudit(TimeStampedModel):
    ...
    state = models.CharField(
        ...
        default=NOT_SET,
        help_text=_(
            "Stores whether the learner linked to this model has consented to have "
            "their information shared with the associated EnterpriseCustomer."
        )
    )
