...
class ValidationMessages(object):
    ...
    COURSE_AND_PROGRAM_ERROR = _(
        "Either \"Course ID\" or \"Program ID\" can"
    ...
    INVALID_EMAIL_OR_USERNAME = _(
        "{argument} does not appear to be a valid "
