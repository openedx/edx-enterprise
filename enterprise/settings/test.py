...
BRAZE_ADMIN_INVITE_CAMPAIGN_ID = 'test-admin-invite-campaign-id'
BRAZE_LEARNER_INVITE_CAMPAIGN_ID = 'test-learner-invite-campaign-id'
BRAZE_ADMIN_INVITE_REMINDER_CAMPAIGN_ID = 'c7effc4f-5cc2-47f5-bbc8-14a4ce2ab7aa'
BRAZE_LEARNER_ADMIN_INVITE_REMINDER_CAMPAIGN_ID = 'f17f8c4f-7dc2-47f5-bbc8-14a4ce2ab7ac'

ADMIN_INVITE_REMINDER_AUTO_CHECK_ON_LMS_STARTUP = False
ADMIN_INVITE_REMINDER_STARTUP_LOCK_TIMEOUT_SECONDS = 300
ADMIN_INVITE_REMINDER_INITIAL_DELAY_DAYS = 7
ADMIN_INVITE_REMINDER_INITIAL_DELAY_SECONDS = 30
ADMIN_INVITE_REMINDER_CADENCE_DAYS = 7
ADMIN_INVITE_REMINDER_CADENCE_SECONDS = 30
