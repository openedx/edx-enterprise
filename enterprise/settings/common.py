...
def plugin_settings(settings):
    ...
    # These two are appended rather than assigned: an OVERRIDE_* setting holds a whole chain of
    # implementations, and both of ours delegate to the previous one, so an operator-configured
    # override must survive.
    _append_override(
        settings,
        'OVERRIDE_GET_LEARNER_GENERIC_NAME',
