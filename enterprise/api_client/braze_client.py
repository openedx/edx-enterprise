"""
Braze campaign client for campaign triggering and campaign management.
...
# Convenience alias with a distinct name to avoid confusion with
# BrazeAPIClient in enterprise.api_client.braze.
CampaignBrazeClient = BrazeCampaignAPIClient
