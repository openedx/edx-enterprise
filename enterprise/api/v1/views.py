...
class EnterpriseCustomerCatalogConfigViewSet(EnterpriseReadOnlyModelViewSet):
    """
    API View to return catalog config.
    """
    serializer_class = serializers.EnterpriseCustomerCatalogConfigSerializer
