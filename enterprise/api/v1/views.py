...
class EnterpriseCustomerViewSet(EnterpriseReadWriteModelViewSet):
    ...
    @action(detail=False, permission_classes=[permissions.IsAuthenticated, IsInEnterpriseGroup])
...
class EnterpriseCustomerCatalogViewSet(EnterpriseReadOnlyModelViewSet):
    ...
    @action(detail=True, url_path='courses/{}'.format(COURSE_KEY_URL_PATTERN), url_name='courses')
    @permission_required(
        'enterprise.can_view_catalog',
    ...
    @action(detail=True, url_path='course_runs/{}'.format(settings.COURSE_ID_PATTERN), url_name='course_runs')
    @permission_required(
        'enterprise.can_view_catalog',
    ...
    @action(detail=True, url_path='programs/(?P<program_uuid>[^/]+)', url_name='programs')
    @permission_required(
        'enterprise.can_view_catalog',
