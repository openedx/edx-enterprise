...
class TestCanvasContentMetadataTransmitter(unittest.TestCase):
    ...
    @responses.activate
    @mock.patch('integrated_channels.canvas.client.CanvasAPIClient.create_content_metadata')
    @mock.patch('integrated_channels.canvas.client.CanvasAPIClient.delete_content_metadata')
    @mock.patch('integrated_channels.canvas.client.CanvasAPIClient.update_content_metadata')
