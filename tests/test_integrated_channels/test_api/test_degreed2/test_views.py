...
class Degreed2ConfigurationViewSetTests(APITest):
    ...
    def test_is_valid_field(self, mock_current_request):
        ...
        self.degreed2_config.decrypted_client_id = ''
        self.degreed2_config.decrypted_client_secret = ''
        ...
        assert missing.get('missing') == ['decrypted_client_id', 'decrypted_client_secret', 'degreed_base_url']
        ...
        self.degreed2_config.decrypted_client_id = 'ayylmao'
        self.degreed2_config.decrypted_client_secret = 'whatsup'
