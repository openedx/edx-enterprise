...
class TestEnterpriseCustomerAPICredentialsViewSet(BaseTestEnterpriseAPIViews):
    ...
    """
    ENTERPRISE_CUSTOMER_API_CREDENTIALS_ENDPOINT = 'enterprise-customer-api-credentials-list'
    ENTERPRISE_CUSTOMER_API_CREDENTIALS_REGENERATION_ENDPOINT = 'regenerate-api-credentials'
    ENTERPRISE_CUSTOMER_API_CREDENTIALS_ENDPOINT_DETAIL = 'enterprise-customer-api-credentials-detail'
