...
class TestEnterpriseCustomerSsoConfigurationViewSet(APITest):
    ...
    def test_fetch_entity_id_from_metadata_xml(self):
        """
        Test expected entityId after parsing metadata xml file.
        """
        metadata_xml = '<EntityDescriptor xmlns="urn:oasis:names:tc:SAML:2.0:metadata" entityID="https://example.com"></EntityDescriptor>'  # pylint: disable=line-too-long
        entityId = fetch_entity_id_from_metadata_xml(metadata_xml)
        assert entityId == "https://example.com"
        metadata_xml = '<ds:SignedInfo> <ds:CanonicalizationMethod Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/> <ds:SignatureMethod Algorithm="http://www.w3.org/2001/04/xmldsig-more#rsa-sha256"/> <ds:Reference URI="#rwth20230801150000"> <ds:Transforms> <ds:Transform Algorithm="http://www.w3.org/2000/09/xmldsig#enveloped-signature"/> <ds:Transform Algorithm="http://www.w3.org/2001/10/xml-exc-c14n#"/> </ds:Transforms> <ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256"/> <ds:DigestValue>oVw/6lXDTOS8zt0kz/6qfB+3CoFu77QqVp7X0rYEPZ4=</ds:DigestValue> </ds:Reference> </ds:SignedInfo> <ds:SignatureValue> CTFf9mVJQhMOb5jF8Kx3kbT0eVleDRe6UZB8mG2MqHekboXSzzl26mEvEq/e8io5J/v0VP+zkAav O8lh58M3v4nRL0vOPS1c6DkwqR5B2EzbSCwxF0qM/u4v20lQKK/ILqN88AZiAUuCYF0DdLoFYgpP 93fIRkXJIRcq4MbGACNbID1W2tIvBaFaEC7wvm8CJodsiqeroSxbMi2XynNq3aA1m5eu2/q4pt6m kFd2hqnXmMY8tzZ90awu1G+kDB/5cmvabBgIYhhRe5oudNHWIooytwLYGCY8JqshisL1orV1s1LX ZJc7596LQ1QuVo/Vx2pS3DCKZmweWMy+/i5fnixizzuba/crRlGMkBVpJ2XMvLrjBmAWgH6PJl+F IkuryyzjDHR8QLEBTHHeSjGv4BcwPV6mKhAx0nwkdY4nUiBzcuO8DKDzVoHrdVaIqLMVAmxVXxDg HuBnoXjxnJ4dJNpAIUR+l4eBJ2yjPGY+M8hrIxQ2jZ1voe4CLz5SVs15s9lQxiIo7BI0eKtDmg1g dU1ImlZKWOLccIBc0L5+fEBwkPQJwlmzSDvGnGZOGky2aoNWr42uOEWRuocW8BzmVaUAhL4dOClX B57/rnAgaNbka6qCPr2sUiuvgLmEn8F0AfVe63I3KYcLhVgtUhKU0FU+bVmowazwKfPsFngrb70= </ds:SignatureValue> <ds:KeyInfo> <ds:KeyValue> <ds:RSAKeyValue> <ds:Modulus> 2S58JzN538VW5Vr/vCIuSQZWnkGF1CowK+1UBx08JnuHYJOAYqgoVGceT+U2LS2BpejghHAq5I/p 4LtKDWW+ZqDrLljfQwjEdnMgitcEh705LnIcTQ9JNnjZp9D1kxaQw8j1urBTZb/As00QEVzpGLbR oPNhLRGNEjBuoPrfLaOuH/yoEp+sq48EfHh+hY9fyY85YXOLXaeLqQiQFeE8dhisF8Ogw+k5mwue 10WLDDp1uA97mFHK0y/FwgLRwL950MGqIx581NJYINBJluw9wLvKv4++XrTNCgBGXx4kF8UiEUVv vm1wt31BAWcEzyz1+aj1ke8r7JlGCzpGfcd1FjhCpAUgG1g/hq2cXm7z4pl359f+zOXDNyHeNkGv ID6w4SgdvRCsigNu1uKz3xM74g7ISFkjssQ36sOXZZjCcWhJE0cMrIaezltkOSmXc1mNf9vyrLBg OBKQt1dxNDz+an/xcpUW8G9uGGgelYn3WxpYZ7NKOLao8Tmv6Y8PagAGpgckjNGrbzIaClSLjEFy zIOUgzEWkktbPfOEiedEy3uO6IRrOtnblHKrYMm2tseMojV5uFh4a8JimiO48haJQpAqgneOcjRi XGP3ibGazqvFmewvB/5uO9hWIV+STEqfdqiZuas2j+tJKeLPcAumHu1wNcY+f/zX4qF7FtN2Dds= </ds:Modulus> <ds:Exponent>AQAB</ds:Exponent> </ds:RSAKeyValue> </ds:KeyValue> <ds:X509Data> <ds:X509Certificate> MIIH5TCCBc2gAwIBAgIMKFc71tGDqscdVu3zMA0GCSqGSIb3DQEBCwUAMIGVMQswCQYDVQQGEwJE RTFFMEMGA1UECgw8VmVyZWluIHp1ciBGb2VyZGVydW5nIGVpbmVzIERldXRzY2hlbiBGb3JzY2h1 bmdzbmV0emVzIGUuIFYuMRAwDgYDVQQLDAdERk4tUEtJMS0wKwYDVQQDDCRERk4tVmVyZWluIENv bW11bml0eSBJc3N1aW5nIENBIDIwMjIwHhcNMjMwNDEzMDgzMzEwWhcNMjYwNjI2MDgzMzEwWjCB gzELMAkGA1UEBhMCREUxHDAaBgNVBAgME05vcmRyaGVpbi1XZXN0ZmFsZW4xDzANBgNVBAcMBkFh Y2hlbjEUMBIGA1UECgwLUldUSCBBYWNoZW4xEjAQBgNVBAsMCUlUIENlbnRlcjEbMBkGA1UEAwwS c3NvLnJ3dGgtYWFjaGVuLmRlMIICIjANBgkqhkiG9w0BAQEFAAOCAg8AMIICCgKCAgEA2S58JzN5 38VW5Vr/vCIuSQZWnkGF1CowK+1UBx08JnuHYJOAYqgoVGceT+U2LS2BpejghHAq5I/p4LtKDWW+ ZqDrLljfQwjEdnMgitcEh705LnIcTQ9JNnjZp9D1kxaQw8j1urBTZb/As00QEVzpGLbRoPNhLRGN EjBuoPrfLaOuH/yoEp+sq48EfHh+hY9fyY85YXOLXaeLqQiQFeE8dhisF8Ogw+k5mwue10WLDDp1 uA97mFHK0y/FwgLRwL950MGqIx581NJYINBJluw9wLvKv4++XrTNCgBGXx4kF8UiEUVvvm1wt31B AWcEzyz1+aj1ke8r7JlGCzpGfcd1FjhCpAUgG1g/hq2cXm7z4pl359f+zOXDNyHeNkGvID6w4Sgd vRCsigNu1uKz3xM74g7ISFkjssQ36sOXZZjCcWhJE0cMrIaezltkOSmXc1mNf9vyrLBgOBKQt1dx NDz+an/xcpUW8G9uGGgelYn3WxpYZ7NKOLao8Tmv6Y8PagAGpgckjNGrbzIaClSLjEFyzIOUgzEW kktbPfOEiedEy3uO6IRrOtnblHKrYMm2tseMojV5uFh4a8JimiO48haJQpAqgneOcjRiXGP3ibGa zqvFmewvB/5uO9hWIV+STEqfdqiZuas2j+tJKeLPcAumHu1wNcY+f/zX4qF7FtN2DdsCAwEAAaOC AkMwggI/MAkGA1UdEwQCMAAwDgYDVR0PAQH/BAQDAgWgMB0GA1UdJQQWMBQGCCsGAQUFBwMCBggr BgEFBQcDATAdBgNVHQ4EFgQUib3Vh5n1cwAilImYwcZcldifoTAwHwYDVR0jBBgwFoAUxChdi0OP UrXj7ayr3DhxiLiBjAMwHQYDVR0RBBYwFIISc3NvLnJ3dGgtYWFjaGVuLmRlMIGbBgNVHR8EgZMw gZAwRqBEoEKGQGh0dHA6Ly9jZHAxLnBjYS5kZm4uZGUvZGZuLXZlcmVpbi1jb21tdW5pdHktY2Ev cHViL2NybC9jYWNybC5jcmwwRqBEoEKGQGh0dHA6Ly9jZHAyLnBjYS5kZm4uZGUvZGZuLXZlcmVp bi1jb21tdW5pdHktY2EvcHViL2NybC9jYWNybC5jcmwwgekGCCsGAQUFBwEBBIHcMIHZMDMGCCsG AQUFBzABhidodHRwOi8vb2NzcC5wY2EuZGZuLmRlL09DU1AtU2VydmVyL09DU1AwUAYIKwYBBQUH MAKGRGh0dHA6Ly9jZHAxLnBjYS5kZm4uZGUvZGZuLXZlcmVpbi1jb21tdW5pdHktY2EvcHViL2Nh Y2VydC9jYWNlcnQuY3J0MFAGCCsGAQUFBzAChkRodHRwOi8vY2RwMi5wY2EuZGZuLmRlL2Rmbi12 ZXJlaW4tY29tbXVuaXR5LWNhL3B1Yi9jYWNlcnQvY2FjZXJ0LmNydDAaBgNVHSAEEzARMA8GDSsG AQQBga0hgiwCAQcwDQYJKoZIhvcNAQELBQADggIBALTpAH931bSB9nDv1WlxYpCokopa9NyjKWRT jUySpvPx+6ORxkvW9+mkKeftyUMKiEclhLf+b99oCNZN2E0f11DgHQZP28h9izroZxnaw0rT91L3 eV8fvTrAXd4hrHY0tBYca+FJgWh1KI6fDwNfS415OOjcl2B3+lWY40AMVRnebqOqv/VySnXMBk0D n5Tl+Mz3hNkeBGwGNnZeORCp9uZuT8nzjNtG52xftdXhQWIDiYdmEJzm/8JMNlq6LPSotaqCSDX9 vno6j3fGtQNHgkvZD2RlnoDGeQDqbxQsvyda1vi+8F0l2KBcDGPs2dCHXBXQNa+lJnZZDOt7r6ec QvRWonfLgjlaFeMoXjNDYffirp+wGMNS3HC9uNY/FYMK1j0fLZcbuW6iAwLQc9OF5671v1xhUK5V DvJcmy3WXEfidS2EmUJoKaz5eVWioRbvGOEYgOJvulIMysOAreoJ8ELVmho4HreeuzN9auWzJhvt cre88zwWJLjahVVmn647vCgu6Lf/6ojnGeFrzBybziyHkx0P7VlquK/4ePQGSEwMcJV7lYBT/bNv dB1nXk9ZWELLQ4i+HjlMk7ATuubwIPHmLXB+WwhIRUPw400EK3HT7FgeKHnYvgn+/U+NmaGzehXi R0l0kZAQRU5zI4nw2eaGhLgw69rIm1IDCXDgqCTP </ds:X509Certificate> </ds:X509Data> </ds:KeyInfo> </ds:Signature> <EntityDescriptor entityID="https://login.rz.rwth-aachen.de/shibboleth">'  # pylint: disable=line-too-long
        entityId = fetch_entity_id_from_metadata_xml(metadata_xml)
        assert entityId == "https://login.rz.rwth-aachen.de/shibboleth"
        metadata_xml = '<md:EntitiesDescriptor xmlns:md="urn:oasis:names:tc:SAML:2.0:metadata"> <md:EntityDescriptor entityID="https://idp1.example.com"> <md:IDPSSODescriptor></md:IDPSSODescriptor> </md:EntityDescriptor> <md:EntityDescriptor entityID="https://idp2.example.com"> <md:IDPSSODescriptor></md:IDPSSODescriptor> </md:EntityDescriptor> </md:EntitiesDescriptor>'  # pylint: disable=line-too-long
        entityId = fetch_entity_id_from_metadata_xml(metadata_xml)
        assert entityId == "https://idp1.example.com"
