# Generated by Django 5.2.10 on 2026-04-24 14:32
        ...
        <tbody>
            ...
            <tr>
              <td align="center" bgcolor="#ffffff" style="padding:20px;Margin:0;background-color:#ffffff">
                <table align="center" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;margin:0 auto;">
                  <tbody>
                    <tr>
                      <td align="center" style="padding:0 7px;Margin:0;font-size:0;line-height:0;">
                        <a href="https://www.facebook.com/edX" target="_blank">
                          <img src="https://fzvpwi.stripocdn.email/content/guids/CABINET_4d3c6887b8ac137f656a3dd54bb5f6c8/images/71001614127047298.png" alt="Facebook" width="35" height="35" border="0" style="display:block;border:0;outline:none;text-decoration:none;">
                        </a>
                      </td>
            
                      <td align="center" style="padding:0 7px;Margin:0;font-size:0;line-height:0;">
                        <a href="https://twitter.com/edXOnline" target="_blank">
                          <img src="https://fzvpwi.stripocdn.email/content/guids/CABINET_4d3c6887b8ac137f656a3dd54bb5f6c8/images/19131614127052508.png" alt="Twitter" width="35" height="35" border="0" style="display:block;border:0;outline:none;text-decoration:none;">
                        </a>
                      </td>
            
                      <td align="center" style="padding:0 7px;Margin:0;font-size:0;line-height:0;">
                        <a href="https://www.linkedin.com/school/edx/" target="_blank">
                          <img src="https://fzvpwi.stripocdn.email/content/guids/CABINET_4d3c6887b8ac137f656a3dd54bb5f6c8/images/42721614127058646.png" alt="LinkedIn" width="35" height="35" border="0" style="display:block;border:0;outline:none;text-decoration:none;">
                        </a>
                      </td>
            
                      <td align="center" style="padding:0 7px;Margin:0;font-size:0;line-height:0;">
                        <a href="https://www.reddit.com/r/edX/" target="_blank">
                          <img src="https://fzvpwi.stripocdn.email/content/guids/CABINET_4d3c6887b8ac137f656a3dd54bb5f6c8/images/23371614127063365.png" alt="Reddit" width="35" height="35" border="0" style="display:block;border:0;outline:none;text-decoration:none;">
                        </a>
                      </td>
            
                      <td align="center" style="padding:0 7px;Margin:0;font-size:0;line-height:0;">
                        <a href="https://api.whatsapp.com/send?text=edX" target="_blank">
                          <img src="https://fzvpwi.stripocdn.email/content/guids/CABINET_4d3c6887b8ac137f656a3dd54bb5f6c8/images/18781614127069989.png" alt="WhatsApp" width="35" height="35" border="0" style="display:block;border:0;outline:none;text-decoration:none;">
                        </a>
                      </td>
                    </tr>
                  </tbody>
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('enterprise', '0245_alter_enterprisecustomer_enable_academies_and_more'),
    ]
